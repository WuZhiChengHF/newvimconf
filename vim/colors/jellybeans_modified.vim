...
hi pythonimport guifg=#00de00 guibg=NONE guisp=NONE gui=NONE ctermfg=40 ctermbg=NONE cterm=NONE
hi pythonexception guifg=#ff0000 guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
hi pythonbuiltinfunction guifg=#00de00 guibg=NONE guisp=NONE gui=NONE ctermfg=40 ctermbg=NONE cterm=NONE
hi pythonoperator guifg=#baccf0 guibg=NONE guisp=NONE gui=NONE ctermfg=189 ctermbg=NONE cterm=NONE
hi pythonexclass guifg=#00de00 guibg=NONE guisp=NONE gui=NONE ctermfg=40 ctermbg=NONE cterm=NONE
...
hi condtional guifg=#3fdcff guibg=NONE guisp=NONE gui=NONE ctermfg=81 ctermbg=NONE cterm=NONE
hi htmlitalic guifg=#7bdcff guibg=NONE guisp=NONE gui=italic ctermfg=117 ctermbg=NONE cterm=NONE
hi htmlboldunderlineitalic guifg=#dcff7b guibg=NONE guisp=NONE gui=bold,italic,underline ctermfg=192 ctermbg=NONE cterm=bold,underline
hi htmlbolditalic guifg=#dcff7b guibg=NONE guisp=NONE gui=bold,italic ctermfg=192 ctermbg=NONE cterm=bold
hi htmlunderlineitalic guifg=#dcff7b guibg=NONE guisp=NONE gui=bold,italic,underline ctermfg=192 ctermbg=NONE cterm=bold,underline
hi htmlbold guifg=#dcff7b guibg=NONE guisp=NONE gui=bold ctermfg=192 ctermbg=NONE cterm=bold
hi htmlboldunderline guifg=#dcff7b guibg=NONE guisp=NONE gui=bold,underline ctermfg=192 ctermbg=NONE cterm=bold,underline
hi htmlunderline guifg=#dcff7b guibg=NONE guisp=NONE gui=underline ctermfg=192 ctermbg=NONE cterm=underline
